...
function toListItem(value) {
	...
	return {
		...
		sessionName: toNullableString(row.session_name),
...
function toStep(value) {
	...
	return {
		...
		exerciseNameTranslation: toNullableString(row.exerciseNameTranslation),
		exerciseVariantName: toNullableString(row.exerciseVariantName),
		exerciseVariantNameTranslation: toNullableString(
			row.exerciseVariantNameTranslation,
		),
