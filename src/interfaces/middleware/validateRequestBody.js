...
const VALIDATION_KEYS = new Map([
	...
	["Choose a supported catalog entity.", "validation.supportedCatalogEntity"],
	["Choose a valid catalog entity.", "validation.validCatalogEntity"],
	["Choose a supported translation locale.", "validation.supportedTranslationLocale"],
	["Enter a translation name.", "validation.translationNameRequired"],
	[
		"Translation name must be 100 characters or fewer.",
		"validation.translationNameLength",
	],
