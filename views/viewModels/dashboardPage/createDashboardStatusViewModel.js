...
export default function createDashboardStatusViewModel({ currentUser, currentProgram, selectedDate }) {
	return {
		...
		days: Array.from({ length: 7 }, (_, index) => {
			...
			return { label: format(date, "EEE").toUpperCase(), dayLabel: format(date, "dd"), isCurrent: index === 3 };
		}),
