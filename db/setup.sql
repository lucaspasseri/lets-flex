...
VALUES
('assets/c6842d88-a584-48c5-9c20-f4b270d25413.svg', 'image/svg+xml', 960, 640, 'curated', 'Barbell bench press exercise illustration', 'exercise_variant', 'barbell-bench-press', 'exercise_variants', 'primary', 'Barbell bench press exercise illustration', 'Ilustração do exercício supino com barra'),
('assets/ae36d1e5-4e77-4a25-9d22-bc82b93e35d3.svg', 'image/svg+xml', 960, 640, 'curated', 'Chest muscle illustration', 'muscle', 'chest', 'muscles', 'primary', 'Chest muscle illustration', 'Ilustração do músculo peitoral'),
('assets/ce5b3f5e-3d3b-48b4-ab6d-efd0da01303a.png', 'image/png', 1536, 1024, 'curated', 'Bench press', 'exercise', 'bench-press', 'exercises', 'primary', 'Bench press', 'Supino'),
('assets/2103e208-fab0-4090-aac3-43b23831bec2.png', 'image/png', 1536, 1024, 'curated', 'Push-up', 'exercise', 'push-up', 'exercises', 'primary', 'Push-up', 'Flexão de braços'),
('assets/d3637649-8db4-41f8-ab9a-efda8e04ad7d.png', 'image/png', 1536, 1024, 'curated', 'Row exercise', 'exercise', 'row', 'exercises', 'primary', 'Row exercise', 'Exercício de remada'),
('assets/d5ddd8f7-be5a-407f-882f-5aa730e64065.png', 'image/png', 1536, 1024, 'curated', 'Leg press', 'exercise', 'leg-press', 'exercises', 'primary', 'Leg press', 'Leg press'),
('assets/6bd95191-8ef3-4e79-90d2-5a26b87b96bf.png', 'image/png', 1536, 1024, 'curated', 'Goblet squat', 'exercise_variant', 'goblet-squat', 'exercise_variants', 'primary', 'Goblet squat', 'Agachamento goblet'),
('assets/3311f613-fb38-4eff-8e24-e7ba3db222a4.png', 'image/png', 1536, 1024, 'curated', 'Hip extension', 'exercise', 'hip-extension', 'exercises', 'primary', 'Hip extension', 'Extensão de quadril'),
('assets/12bccdae-c3c1-4881-87f3-b6740ee342e4.png', 'image/png', 1536, 1024, 'curated', 'Running', 'exercise', 'running', 'exercises', 'primary', 'Running', 'Corrida'),
('assets/e325f2ae-2d43-4e6c-97f8-57a1e4e9bef7.png', 'image/png', 1536, 1024, 'curated', 'Barbell', 'equipment', 'barbell', 'equipments', 'primary', 'Barbell', 'Barra'),
('assets/42acbe1d-c9ec-4aa9-bc41-4eb145803bd2.png', 'image/png', 1536, 1024, 'curated', 'Dumbbell', 'equipment', 'dumbbell', 'equipments', 'primary', 'Dumbbell', 'Halter'),
('assets/17476cd3-0bc4-49cd-b51c-d2c04b756a22.png', 'image/png', 1536, 1024, 'curated', 'Kettlebell', 'equipment', 'kettlebell', 'equipments', 'primary', 'Kettlebell', 'Kettlebell'),
('assets/3705dd49-ad48-4259-a0ef-4855b3f722dd.png', 'image/png', 1536, 1024, 'curated', 'Resistance band', 'equipment', 'resistance-band', 'equipments', 'primary', 'Resistance band', 'Faixa elástica'),
('assets/69b42526-9ad4-4e6c-ab86-559d39db4b38.png', 'image/png', 1536, 1024, 'curated', 'Push movement pattern', 'movement_pattern', 'push', 'movement_patterns', 'primary', 'Push movement pattern', 'Padrão de movimento de empurrar'),
('assets/6a29abbb-a014-4a69-88ed-4499dc21e455.png', 'image/png', 1536, 1024, 'curated', 'Pull movement pattern', 'movement_pattern', 'pull', 'movement_patterns', 'primary', 'Pull movement pattern', 'Padrão de movimento de puxar'),
('assets/1f1ef50f-0277-4d59-b9e7-cb22192defa0.png', 'image/png', 1536, 1024, 'curated', 'Squat movement pattern', 'movement_pattern', 'squat', 'movement_patterns', 'primary', 'Squat movement pattern', 'Padrão de movimento de agachar'),
('assets/9b88ece9-492c-4fe2-a60b-a6785ef4a24d.png', 'image/png', 1536, 1024, 'curated', 'Hinge movement pattern', 'movement_pattern', 'hinge', 'movement_patterns', 'primary', 'Hinge movement pattern', 'Padrão de movimento de dobrar o quadril'),
('assets/b6f17a38-8e80-4b0c-8970-2ca61a84e77d.png', 'image/png', 1536, 1024, 'curated', 'Gait movement pattern', 'movement_pattern', 'gait', 'movement_patterns', 'primary', 'Gait movement pattern', 'Padrão de movimento de marcha'),
('assets/e8f3d661-3495-4a0a-80f4-392538284f2a.png', 'image/png', 1536, 1024, 'curated', 'Standing barbell overhead press', 'exercise', 'overhead-press', 'exercises', 'primary', 'Standing barbell overhead press', 'Desenvolvimento militar com barra em pé'),
('assets/ccd3705a-b5eb-4ba3-89b9-fbb718e66ebc.png', 'image/png', 1536, 1024, 'curated', 'Bodyweight pull-up', 'exercise', 'pull-up', 'exercises', 'primary', 'Bodyweight pull-up', 'Barra fixa'),
('assets/efd5b000-bd42-4172-a45a-bc450d1ce64a.png', 'image/png', 1536, 1024, 'curated', 'Seated lat pulldown', 'exercise', 'lat-pulldown', 'exercises', 'primary', 'Seated lat pulldown', 'Puxada na frente em máquina'),
('assets/130e569e-704d-47c3-8396-2368acf2d4e8.png', 'image/png', 1536, 1024, 'curated', 'Conventional barbell deadlift setup', 'exercise', 'deadlift', 'exercises', 'primary', 'Conventional barbell deadlift setup', 'Levantamento terra convencional com barra'),
('assets/b2f2ead8-33ab-4584-beb8-efa9eb80a19c.png', 'image/png', 1536, 1024, 'curated', 'Barbell back squat', 'exercise', 'squat', 'exercises', 'primary', 'Barbell back squat', 'Agachamento livre com barra'),
('assets/340998ba-b0d2-4ee0-b0b2-0cae7d82d282.png', 'image/png', 1536, 1024, 'curated', 'Romanian deadlift', 'exercise', 'romanian-deadlift', 'exercises', 'primary', 'Romanian deadlift', 'Levantamento terra romeno'),
('assets/34ee5236-0cff-4455-ad04-95252e43d59c.png', 'image/png', 1536, 1024, 'curated', 'Forward lunge', 'exercise', 'forward-lunge', 'exercises', 'primary', 'Forward lunge', 'Afundo à frente'),
('assets/03066415-075d-4c20-8290-4876a38d6a20.png', 'image/png', 1536, 1024, 'curated', 'Reverse lunge', 'exercise', 'reverse-lunge', 'exercises', 'primary', 'Reverse lunge', 'Afundo reverso'),
('assets/2e4c1d73-8a56-4b8a-acfc-2935b55cf97a.png', 'image/png', 1536, 1024, 'curated', 'Split squat', 'exercise', 'split-squat', 'exercises', 'primary', 'Split squat', 'Agachamento dividido'),
('assets/566d2c8d-2192-44be-a14b-adf8406ae7ce.png', 'image/png', 1536, 1024, 'curated', 'Chest fly', 'exercise', 'chest-fly', 'exercises', 'primary', 'Chest fly', 'Crucifixo'),
('assets/139cd887-f039-45e9-9cb1-388abde334d7.png', 'image/png', 1536, 1024, 'curated', 'Lateral raise', 'exercise', 'lateral-raise', 'exercises', 'primary', 'Lateral raise', 'Elevação lateral'),
('assets/a094de67-4bad-4633-a917-c05d48fb95b2.png', 'image/png', 1536, 1024, 'curated', 'Biceps curl', 'exercise', 'biceps-curl', 'exercises', 'primary', 'Biceps curl', 'Rosca bíceps'),
('assets/931521b3-4bce-42c8-b8be-a8c4e5e81edb.png', 'image/png', 1536, 1024, 'curated', 'Cable triceps pushdown', 'exercise', 'triceps-pushdown', 'exercises', 'primary', 'Cable triceps pushdown', 'Tríceps na polia'),
('assets/57b52c65-9394-4116-b4a2-a3a53016a7d1.png', 'image/png', 1536, 1024, 'curated', 'Suspension trainer', 'equipment', 'suspension-trainer-trx', 'equipments', 'primary', 'Suspension trainer', 'Treinador de suspensão'),
('assets/76d6aa65-6d6d-4be3-bd6f-f7f8d6d1d53a.png', 'image/png', 1536, 1024, 'curated', 'Ab wheel', 'equipment', 'ab-wheel', 'equipments', 'primary', 'Ab wheel', 'Roda abdominal'),
('assets/59283658-2dba-43db-90af-89adede0da34.png', 'image/png', 1536, 1024, 'curated', 'Textured medicine ball', 'equipment', 'medicine-ball', 'equipments', 'primary', 'Textured medicine ball', 'Bola medicinal texturizada'),
('assets/239ffd95-f8a0-4d8a-858c-1c70fa5cf26e.png', 'image/png', 1536, 1024, 'curated', 'Seated leg extension', 'exercise', 'leg-extension', 'exercises', 'primary', 'Seated leg extension', 'Extensão de pernas sentada'),
('assets/95ee5c4f-6b98-462d-aff4-91852434304e.png', 'image/png', 1536, 1024, 'curated', 'Prone leg curl', 'exercise', 'leg-curl', 'exercises', 'primary', 'Prone leg curl', 'Flexão de pernas deitado'),
('assets/015bb97c-d889-4f81-8ec4-9c5f5084774f.png', 'image/png', 1536, 1024, 'curated', 'High plank', 'exercise', 'plank', 'exercises', 'primary', 'High plank', 'Prancha alta'),
('assets/ff30f7ef-a27f-485e-aaa8-66e63928bee0.png', 'image/png', 1536, 1024, 'curated', 'Two-handed kettlebell swing', 'exercise', 'kettlebell-swing', 'exercises', 'primary', 'Two-handed kettlebell swing', 'Balanço com kettlebell usando as duas mãos'),
('assets/e58e3ee0-5f6a-46dd-9293-1cb5437a1f35.png', 'image/png', 1536, 1024, 'curated', 'Farmer carry with two dumbbells', 'exercise', 'farmer-carry', 'exercises', 'primary', 'Farmer carry with two dumbbells', 'Caminhada do fazendeiro com dois halteres'),
('assets/d886095e-cfa1-4096-8336-5e71d506bb2c.png', 'image/png', 1536, 1024, 'curated', 'Brisk walking', 'exercise', 'walking', 'exercises', 'primary', 'Brisk walking', 'Caminhada acelerada'),
('assets/9bd69c7c-7513-4d63-a7a4-bc79484ec4c1.png', 'image/png', 1536, 1024, 'curated', 'Stationary cycling', 'exercise', 'cycling', 'exercises', 'primary', 'Stationary cycling', 'Ciclismo em bicicleta ergométrica'),
('assets/7ca15f2b-6887-449a-8fc0-e59326503be8.png', 'image/png', 1536, 1024, 'curated', 'Jump rope', 'exercise', 'jump-rope', 'exercises', 'primary', 'Jump rope', 'Pular corda'),
('assets/8389125a-5646-4321-91ef-975d6cb605cb.png', 'image/png', 1536, 1024, 'curated', 'Elliptical training', 'exercise', 'elliptical-training', 'exercises', 'primary', 'Elliptical training', 'Treino em máquina elíptica'),
('assets/eab2b0c8-2922-475a-b595-682b36fb285e.png', 'image/png', 1536, 1024, 'curated', 'Indoor rowing', 'exercise', 'rowing', 'exercises', 'primary', 'Indoor rowing', 'Remo indoor'),
('assets/c35bc9de-5eff-40f1-a172-3a2e574c2a09.png', 'image/png', 1536, 1024, 'curated', 'Guided-bar Smith machine', 'equipment', 'smith-machine', 'equipments', 'primary', 'Guided-bar Smith machine', 'Máquina Smith com barra guiada'),
('assets/b8354233-1e72-44e3-b8a0-cf00df1bc429.png', 'image/png', 1536, 1024, 'curated', 'Dual-pulley cable machine', 'equipment', 'cable-machine', 'equipments', 'primary', 'Dual-pulley cable machine', 'Máquina de cabos com polias duplas'),
('assets/dca4db99-f929-4606-a904-8f4962070121.png', 'image/png', 1536, 1024, 'curated', '45-degree sled leg press', 'equipment', 'leg-press-machine', 'equipments', 'primary', '45-degree sled leg press', 'Leg press com trenó a 45 graus'),
('assets/0b7b36e0-3f2d-4c84-b841-b5bf2c1c0118.png', 'image/png', 1536, 1024, 'curated', 'Seated selectorized chest press', 'equipment', 'chest-press-machine', 'equipments', 'primary', 'Seated selectorized chest press', 'Máquina de supino sentado com pilha de pesos'),
('assets/569c4d30-6d78-4044-a2a0-443f2fe48fff.png', 'image/png', 1536, 1024, 'curated', 'Plate-loaded hack squat', 'equipment', 'hack-squat-machine', 'equipments', 'primary', 'Plate-loaded hack squat', 'Hack squat com carga por anilhas'),
('assets/824d30eb-d792-4d34-abe7-571e11d89421.png', 'image/png', 1536, 1024, 'curated', 'Seated leg extension machine', 'equipment', 'leg-extension-machine', 'equipments', 'primary', 'Seated leg extension machine', 'Máquina de extensão de pernas sentada'),
('assets/0cb164f2-0183-4b20-8dac-550317d36fdb.png', 'image/png', 1536, 1024, 'curated', 'Prone leg curl machine', 'equipment', 'leg-curl-machine', 'equipments', 'primary', 'Prone leg curl machine', 'Máquina de flexão de pernas deitado'),
('assets/6e42d0c1-c0e2-4626-8baa-9b45136cd30d.png', 'image/png', 1536, 1024, 'curated', 'Reverse-pec-deck rear delt machine', 'equipment', 'rear-delt-machine', 'equipments', 'primary', 'Reverse-pec-deck rear delt machine', 'Máquina de deltoide posterior reversa'),
('assets/051c745b-2889-4fd9-8217-48eaf719b148.png', 'image/png', 1536, 1024, 'curated', 'Seated lat pulldown machine', 'equipment', 'lat-pulldown-machine', 'equipments', 'primary', 'Seated lat pulldown machine', 'Máquina de puxada na frente sentada'),
('assets/4e3a9028-cb5e-44dc-b8a7-e7d688128ca4.png', 'image/png', 1536, 1024, 'curated', 'Freestanding pull-up bar station', 'equipment', 'pull-up-bar', 'equipments', 'primary', 'Freestanding pull-up bar station', 'Estação de barra fixa independente'),
('assets/ecb310d9-d32d-419e-8bfd-dd9291cb1f19.png', 'image/png', 1536, 1024, 'curated', 'Freestanding parallel dip bar station', 'equipment', 'dip-bar', 'equipments', 'primary', 'Freestanding parallel dip bar station', 'Estação de barras paralelas'),
('assets/dad23553-3ed3-4a57-9952-353fa2693db3.png', 'image/png', 1536, 1024, 'curated', 'Adjustable jump rope', 'equipment', 'jump-rope', 'equipments', 'primary', 'Adjustable jump rope', 'Corda de pular ajustável'),
('assets/bd5df11f-b5a1-479a-8352-65b52a29d07c.png', 'image/png', 1536, 1024, 'curated', 'Motorized treadmill', 'equipment', 'treadmill', 'equipments', 'primary', 'Motorized treadmill', 'Esteira motorizada'),
('assets/4095e8ff-2d78-47ba-9f76-671994044658.png', 'image/png', 1536, 1024, 'curated', 'Upright stationary exercise bike', 'equipment', 'stationary-bike', 'equipments', 'primary', 'Upright stationary exercise bike', 'Bicicleta ergométrica vertical'),
('assets/277205d9-c1ad-4afd-aa76-b3ab77d517c9.png', 'image/png', 1536, 1024, 'curated', 'Elliptical trainer', 'equipment', 'elliptical-trainer', 'equipments', 'primary', 'Elliptical trainer', 'Treinador elíptico'),
('assets/9ef8c9f2-6d4b-4d8c-9ca6-3733ede17bb7.png', 'image/png', 1536, 1024, 'curated', 'Indoor rowing machine', 'equipment', 'rowing-machine', 'equipments', 'primary', 'Indoor rowing machine', 'Máquina de remo indoor'),
('assets/0d342a97-8aa7-4d34-a7d3-b6de5f5c80d3.png', 'image/png', 1536, 1024, 'curated', 'Flat weight bench', 'equipment', 'flat-bench', 'equipments', 'primary', 'Flat weight bench', 'Banco reto de musculação'),
('assets/6e902d49-8170-46ee-a06c-0d58729d61c3.png', 'image/png', 1536, 1024, 'curated', 'Adjustable incline weight bench', 'equipment', 'incline-bench', 'equipments', 'primary', 'Adjustable incline weight bench', 'Banco inclinado ajustável'),
('assets/d98ec878-8670-4105-9c85-7e34f3e85a25.png', 'image/png', 1536, 1024, 'curated', 'Decline weight bench with ankle rollers', 'equipment', 'decline-bench', 'equipments', 'primary', 'Decline weight bench with ankle rollers', 'Banco declinado com rolos para tornozelos'),
('assets/850afc0c-6d8a-4731-95b6-2b544b108e82.png', 'image/png', 1536, 1024, 'curated', 'Open-front squat rack with safety arms', 'equipment', 'squat-rack', 'equipments', 'primary', 'Open-front squat rack with safety arms', 'Rack de agachamento aberto com braços de segurança'),
('assets/2d80b2fa-8a08-490b-ae91-28059d1c3f26.png', 'image/png', 1536, 1024, 'curated', 'Four-post power rack with safety pins', 'equipment', 'power-rack', 'equipments', 'primary', 'Four-post power rack with safety pins', 'Power rack de quatro postes com pinos de segurança'),
('assets/081e3de1-6055-4684-8158-d74370e081d4.png', 'image/png', 1536, 1024, 'curated', 'Lunge movement pattern', 'movement_pattern', 'lunge', 'movement_patterns', 'primary', 'Lunge movement pattern', 'Padrão de movimento de afundo'),
('assets/f13490a7-762a-4909-8d7d-7b3f064bfc5a.png', 'image/png', 1536, 1024, 'curated', 'Loaded carry movement pattern', 'movement_pattern', 'carry', 'movement_patterns', 'primary', 'Loaded carry movement pattern', 'Padrão de movimento de transporte de carga'),
('assets/398e6c88-4553-4f4d-bcb7-6c4538bb73b4.png', 'image/png', 1536, 1024, 'curated', 'Trunk rotation movement pattern', 'movement_pattern', 'rotation', 'movement_patterns', 'primary', 'Trunk rotation movement pattern', 'Padrão de movimento de rotação do tronco'),
('assets/8d2152c1-03e1-4ddc-89ee-c0a99bb2e991.jpg', 'image/jpeg', 730, 456, 'curated', 'abdomen', 'muscle', 'abs', 'muscles', 'primary', 'abdomen', 'abdominal'),
('assets/ab2a5fc5-f6ab-468b-9b88-b5bf776bd106.jpg', 'image/jpeg', 1124, 1092, 'curated', '123', 'muscle', 'abductors', 'muscles', 'primary', '123', '345')
), inserted_assets AS (
